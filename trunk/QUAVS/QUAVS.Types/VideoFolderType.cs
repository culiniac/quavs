...
namespace QUAVS.Types
{
    ...
    public class VideoFolderType
    {
        ...
        public VideoFolderType(string vf)
        {
            _vf = vf;
        }
        ...
        public static implicit operator string(VideoFolderType vf)
        {
            if (vf != null)
                return vf._vf;
            else
        ...
        /// <param name="vs">The vs.</param>
        /// <returns>The result of the conversion.</returns>
        public static implicit operator VideoFolderType(string vf)
        {
            return new VideoFolderType(vf);
        }
    }
